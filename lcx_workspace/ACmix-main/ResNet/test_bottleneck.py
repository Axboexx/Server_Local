...
class ACmix(nn.Module):
    ...
    def forward(self, x):
        ...
        temp = q_att.unsqueeze(2)
        temp_q_pe = q_pe.unsqueeze(2)
        # temp:[8,16,1,56,56]
        # q_pe.unsqueeze(2):[1,16,1,56,56]
        # unfold_k:[8,16,49,56,56]
        # unfold_rpe：[1,16,49,56,56]
        test = unfold_k + q_pe.unsqueeze(2)
        # test:[8,16,49,56,56]
