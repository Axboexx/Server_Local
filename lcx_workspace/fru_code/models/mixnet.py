...
class MixNet(nn.Module):
    ...
    mixnet_m = [(24, 24, [3], [1], [1], 1, 1, 'ReLU', 0.0),
                ...
                (32, 32, [3, 5, 7], [1, 1], [1, 1], 1, 3, 'ReLU', 0.0),
                (32, 40, [3, 5, 7], [1], [1], 2, 6, 'Swish', 0.5),
                (40, 40, [3, 5, 7], [1, 1], [1, 1], 1, 6, 'Swish', 0.5),
                (40, 40, [3, 5, 7], [1, 1], [1, 1], 1, 6, 'Swish', 0.5),
                (40, 40, [3, 5, 7], [1, 1], [1, 1], 1, 6, 'Swish', 0.5),
                ...
                (80, 80, [3, 5, 7, 9], [1, 1], [1, 1], 1, 6, 'Swish', 0.25),
                (80, 80, [3, 5, 7, 9], [1, 1], [1, 1], 1, 6, 'Swish', 0.25),
                (80, 120, [3, 5, 7, 9], [1], [1], 1, 6, 'Swish', 0.5),
    ...
    def __init__(self, net_type='mixnet_s', input_size=224, num_classes=1000, stem_channels=16,
                 feature_size=1536, depth_multiplier=1.0):
